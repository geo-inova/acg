    ...
    public class AcgShpReader : AcgReader
    {
        ...
        public override List<IAcgObject> Read(string filePath)
        {
            ...
            if (this.Mappings != null)
            {
                ...
                string key = "";
                if (this.ObjectType == AcgObjectType.Building) key = "AcgBuilding";
                else key = "AcgParcel";
                ...
                foreach (int i in Enumerable.Range(0, reader.RecordCount))
                {
                    ...
                    foreach (AcgMapping mapping in mappingList)
                    {
                        ...
                        {
                            AcgParcel _parcel = new AcgParcel();
                            switch (mapping.Source)
                            {
                                case "BlockNumber":
                                    _parcel.BlockNumber = value;
                                    objectList[i] = _parcel;
                                    break;
                                case "Number":
                                    ...
                                    break;
                                case "CountryName":
                                    _parcel.CountryName = value;
                                    objectList[i] = _parcel;
                                    break;
                                case "StateName":
                                    _parcel.StateName = value;
                                    objectList[i] = _parcel;
                                    break;
                                case "SubmissionNames":
                                    _parcel.SubmissionNames = value;
                                    objectList[i] = _parcel;
                                    break;
                                case "CadastralUnitName":
                                    _parcel.CadastralUnitName = value;
                                    objectList[i] = _parcel;
                                    break;
                                case "Type":
                                    _parcel.Type = Convert.ToInt32(value);
                                    objectList[i] = _parcel;
                                    break;
                                case "LocationDescription":
                                    _parcel.LocationDescription = value;
                                    objectList[i] = _parcel;
                                    break;
                                case "MunicipalityName":
                                    _parcel.MunicipalityName = value;
                                    objectList[i] = _parcel;
                                    break;
                                case "FootprintSurfaceFixed":
                                    _parcel.FootprintSurfaceFixed = Convert.ToDouble(value);
                                    objectList[i] = _parcel;
                                    break;
                                case "RegionName":
                                    _parcel.RegionName = value;
                                    objectList[i] = _parcel;
                                    break;
                                case "PreviousNumber":
                                    _parcel.PreviousNumber = value;
                                    objectList[i] = _parcel;
                                    break;
                                case "SoilType":
                                    _parcel.SoilType = Convert.ToInt32(value);
                                    objectList[i] = _parcel;
                                    break;
                                case "SubmissionFlag":
                                    _parcel.SubmissionFlag = Convert.ToInt16(value);
                                    objectList[i] = _parcel;
                                    break;
                                case "ZoneNumber":
                                    _parcel.ZoneNumber = value;
                                    objectList[i] = _parcel;
                                    break;
                                default:
                                    break;
